...
\pagebreak
The modelled baseline PM2.5, PM10 and SO~2~ resulting from the industrial point source is shown below.
...
levelplot(crop(hh_pm10_exceed, kpext), main = "Count of days when PM10 from households \nexceeded specified concentration", sub = "182 days", par.settings=BuRdTheme) + addkwa()
```
