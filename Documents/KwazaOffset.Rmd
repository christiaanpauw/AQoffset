...
load(paste(datadir, "/kwazapopRaster.Rda", sep = "")) # sy naam in r3
r3 <- r3*2.3 # lelike hack om die bevolking reg te kry - Worldpop is verkeerd
...
addkwa2 <- function() {latticeExtra::layer(sp::sp.polygons(KWA, lwd = 10))}
txtkwa <- function() {latticeExtra::layer(panel.text(x = coordinates(KWA)[,1], 
                                       y = coordinates(KWA)[,2], 
