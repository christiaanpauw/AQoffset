#' particle_ratio_target Calculates the target of an offset intervention according to the 
...
#' @param What result to return. result ="target" returns the proportion of the offset source 
...
#' @param numeric Of how many units is source 2 made up. If NULL report proportion default NULL
